...
deviceType = "LAE BIT25B1S3WH-8TM-GDM-23"
deviceTypeName = "LAE BIT25B1S3WH-8TM-GDM-23"
...
valueDescriptions["T1"] = {"dataType":dataTypeFloat,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"Case Temp","unitType":unitTypeTemperature, "defaultLog":"true"}
valueDescriptions["T2"] = {"dataType":dataTypeFloat,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"Evaporator Temp","unitType":unitTypeTemperature, "defaultLog":"true"}
valueDescriptions["T3"] = {"dataType":dataTypeFloat,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"Product Temp","unitType":unitTypeTemperature, "defaultLog":"true"}
valueDescriptions["THI"] = {"dataType":dataTypeFloat,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"HACCP High Temp","unitType":unitTypeTemperature, "defaultLog":"true"}
valueDescriptions["TLO"] = {"dataType":dataTypeFloat,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"HACCP Low Temp","unitType":unitTypeTemperature, "defaultLog":"true"}
valueDescriptions["CND"] = {"dataType":dataTypeInt,"valueType":valueTypeOutput,"significantDigits":1,"displayName":"CND","unitText":"weeks", "defaultLog":"true", "hide":"true"}
valueDescriptions["LOCSTAT"] = {"dataType":dataTypeBool,"dataList":{"true":"Locked", "false": "Unlocked"},"valueType":valueTypeOutput,"displayName":"Keypad Lock Status"}

# 102 - Output flag
valueDescriptions["COMPOUT"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Compressor Relay","defaultLog":"true"}
valueDescriptions["AUX1OUT"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Fan","defaultLog":"true"}
valueDescriptions["AUX2OUT"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Light"}

# OUTPUT - Status Flag bits
# 100 - Status flag
valueDescriptions["ALARM"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Alarm Status"}
valueDescriptions["MUTE"] = {"dataType":dataTypeBool,"dataList":{"true":"Mute", "false": "No"},"valueType":valueTypeOutput,"displayName":"Mute", "hide":"true"}
valueDescriptions["DEFROST"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Defrost Status", "defaultLog":"true"}
valueDescriptions["DOOR"] = {"dataType":dataTypeBool,"dataList":{"true":"Open", "false": "Closed"},"valueType":valueTypeOutput,"displayName":"Door Switch Status", "defaultLog":"true"}
valueDescriptions["TESTMODE"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Test Mode", "hide":"true"}
valueDescriptions["STANDBY"] = {"dataType":dataTypeBool,"dataList":{"true":"Standby", "false": "No"},"valueType":valueTypeOutput,"displayName":"Standby Status"}
# 101 - Alarm flag
...
valueDescriptions["HIGHCONDALARM"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"High Condenser Temp","description":"High Condenser Alarm"}
...
valueDescriptions["LIGHTS"] = {"dataType":dataTypeBool,"dataList":{"true":"On", "false": "Off"},"valueType":valueTypeOutput,"displayName":"Lights", "defaultLog":"true"}

# CONFIG

#CFG_1 BITS
valueDescriptions["SB"] = {"dataType":dataTypeBool,"dataList":{"true":"Yes", "false": "No"},"valueType":valueTypeConfig,"displayName":"SB","description":"Standby button enable","default":"0"}
valueDescriptions["LOC"] = {"dataType":dataTypeBool,"dataList":{"true":"Locked", "false": "Unlocked"},"valueType":valueTypeConfig,"displayName":"LOC","description":"Keypad lock"}
...
valueDescriptions["T2E"] = {"dataType":dataTypeBool,"dataList":{"true":"Yes", "false": "No"},"valueType":valueTypeConfig,"displayName":"T2","description":"Probe T2 enable"}
valueDescriptions["POF"] = {"dataType":dataTypeBool,"dataList":{"true":"Yes", "false": "No"},"valueType":valueTypeConfig,"displayName":"POF","description":"Potentiometer standby enabling"}
...
valueDescriptions["TLD"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"TLD","description":"Delay for min and max temp logging","unitText":"min","default":"5.0"}
...
valueDescriptions["DPD"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"DPD","description":"Drain pump down","unitText":"sec","default":"0"}
valueDescriptions["DRN"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"DRN","description":"Drain down time","unitText":"min","default":"0"}
...
valueDescriptions["AHT"] = {"displayName":"AHT","description":"Condensation temp alarm","dataType":dataTypeFloat,"valueType":valueTypeConfig,"unitType":unitTypeTemperature,"significantDigits":1,"default":"82"}
...
valueDescriptions["IIFC"] = {"displayName":"IIFC","description":"Fan mode during thermostatic control [II]","dataType":dataTypeList,"valueType":valueTypeConfig,"dataList":{"0":"NON","1":"TMP","2":"TIM"},"default":"1"}
...
class Device(deviceObject.NetworkDeviceObject):
  ...
  def _prepareSetDeviceConfigurationTransactions(self):
    ...
    for configItem in self.configModbusList:
      ...
      if key == "CFG_1":
        ...
        value = value | 0x0200 if self._newDeviceConfigurationValues["POF"] else value
  ...
  def _prepareLoggingTransactions(self, valueToLog):
    ...
    if "T1" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(0, 1), "T1"))

    if "T2" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(1, 1), "T2"))

    if "T3" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(2, 1), "T3"))
    ...
    # Output flag
    setOutputFlag = set(["COMPOUT","AUX1OUT","AUX2OUT"])
        ...
        with self.lock:
          if isinstance(transaction.response, readHoldingRegistersResponse):
            ...
            if transaction.tag == "StatusFlag":
              ...
              self._values["AUX1OUT"] = ((value & 0x2) > 0)
              self._values["AUX2OUT"] = ((value & 0x4) > 0)
              self.ProcessVirtualProps( transaction.tag )
              ...
              self._values["POF"] = ((value & 0x0200) > 0)
