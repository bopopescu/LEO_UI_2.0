...
deviceType = "LAE BR1-28C1Q5W-B"
deviceTypeName = "LAE BR1-28C1Q5W-B"
...
valueDescriptions["DIG Input 3"] = {"dataType":dataTypeBool,"unitType":"OnOff","dataList":{"true":"Open", "false": "Closed"},"valueType":valueTypeOutput,"displayName":"Digital Input 3","description":"Digital Input 3", "defaultLog":"true"}
...
valueDescriptions["C-H"] = {"dataType":dataTypeBool,"dataList":{"true":"HEA", "false": "REF"},"valueType":valueTypeConfig,"displayName":"C-H","description":"Refrigerating or heating mode","default":"false"}
...
valueDescriptions["DFB"] = {"dataType":dataTypeBool,"dataList":{"true":"Yes", "false": "No"},"valueType":valueTypeConfig,"displayName":"DFB","description":"Defrost timer backup","default":"0"}
...
valueDescriptions["FID"] = {"dataType":dataTypeBool,"dataList":{"true":"Yes", "false": "No"},"valueType":valueTypeConfig,"displayName":"FID","description":"Fans active during defrost","default":"0"}
...
valueDescriptions["IISP"] = {"displayName":"IISP","description":"Setpoint [II]","dataType":dataTypeFloat,"valueType":valueTypeConfig,"unitType":unitTypeTemperature,"significantDigits":1,"default":"5.0"}
...
valueDescriptions["DAD"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"DAD","description":"Delay before door opening alarm","unitText":"min","default":"5"}
...
valueDescriptions["D1A"] = {"dataType":dataTypeBool,"dataList":{"true":"Closed", "false": "Open"},"valueType":valueTypeConfig,"displayName":"D1A","description":"Digital input 1 activation","default":"false"}
...
valueDescriptions["D3A"] = {"dataType":dataTypeBool,"dataList":{"true":"Closed", "false": "Open"},"valueType":valueTypeConfig,"displayName":"D3A","description":"Digital input 3 activation","default":"false"}
...
valueDescriptions["2CD"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"2CD","description":"Aux compressor start delay","unitText":"sec","default":"30"}
...
class Device(deviceObject.NetworkDeviceObject):
  ...
  def _prepareLoggingTransactions(self, valueToLog):
    ...
    if "DIG Input 3" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(145, 1), "DIG Input 3"))
