...
deviceType = "LAE BIT25B1S3W-1JW"
deviceTypeName = "LAE BIT25B1S3W-1JW"
...
valueDescriptions["T3M"] = {"displayName":"T3","description":"Probe 3 operation","dataType":dataTypeList,"valueType":valueTypeConfig,"dataList":{"0":"DSP","1":"CND"},"default":"0"}
...
valueDescriptions["OT1"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"OT1","description":"Activation time of OAx","unitText":"min","default":"0"}
valueDescriptions["OT2"] = {"dataType":dataTypeInt,"valueType":valueTypeConfig,"displayName":"OT2","description":"Pause between OAx activations","unitText":"hrs","default":"1"}
valueDescriptions["OA1"] = {"displayName":"OA1","description":"AUX 1 output operation","dataType":dataTypeList,"valueType":valueTypeConfig,"dataList":{"0":"NON","1":"FAN","2":"DEF","3":"LGT","4":"0-1","5":"ALO","6":"ALC","7":"TIM"},"default":"0"}
valueDescriptions["OA2"] = {"displayName":"OA2","description":"AUX 2 output operation","dataType":dataTypeList,"valueType":valueTypeConfig,"dataList":{"0":"NON","1":"FAN","2":"DEF","3":"LGT","4":"0-1","5":"ALO","6":"ALC","7":"TIM"},"default":"0"}
...
class Device(deviceObject.NetworkDeviceObject):
  ...
  def _prepareLoggingTransactions(self, valueToLog):
    ...
    if "THI" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(261, 1), "THI"))

    if "TLO" in valueToLog:
      networkTrans.transactions.append(NetworkMessage(readHoldingRegisters(262, 1), "TLO"))
