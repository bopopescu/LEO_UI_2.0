...
linuxFiles = [ '/etc/rc.local', '/etc/logrotate.d/gunicorn','/etc/asound.conf', '/usr/share/X11/xorg.conf.d/50-novtswitch.conf', '/etc/ssh/sshd_config', '/etc/postfix/main.cf', ' /etc/ntp.conf-ORIG','/etc/ntp.conf-CUST','/etc/postfix/sasl_passwd']
